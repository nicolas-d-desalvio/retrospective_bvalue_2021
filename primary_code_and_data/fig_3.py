...
def main(na_time,dist_threshold,precut_magnitude,start_t,grid,path):
    ...
    for i in tqdm(range(len(main_events[:,0]))):
        if i == 48:# or i == 121: # This line is if you wish to single out a specific earthquake, for all Eqs use the next line instead
...
# =============================================================================
            ...
            if len(TLS_List) > 0:
                 ...
                 plt.ylabel('Percent Change in b-value')
                 plt.title('Landers Alerts vs Time over 15 days',fontsize=12)
                 plt.xlim(0,25)
                 plt.ylim(-75,75)
                 plt.tight_layout()
            ...
            if len(TLS_List) > 0:
                 ...
                 plt.xlabel('Days After Event')
                 plt.ylabel('Percent Change in b-value')
                 plt.title('Landers Alerts vs Time over One Year',fontsize=12)
                 plt.xlim(0,370)
                 plt.ylim(-75,75)
                 plt.tight_layout()
                 plt.savefig(path+'{:03d}'.format(i)+'_time_variability.png')
                 plt.savefig(path+'{:03d}'.format(i)+'_time_variability.svg')
