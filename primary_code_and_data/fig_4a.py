...
def main(na_time,dist_threshold,precut_magnitude,start_t,grid,path):
    ...
    for i in tqdm(range(len(main_events[:,0]))):
        if i == 47:# or i == 121: # This line is if you wish to single out a specific earthquake, for all Eqs use the next line instead
